    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-emerald-50/50 to-white">
      <div className="max-w-md w-full space-y-8">
        ...
        >
          ...
          <h2 className="text-gray-600">Join FlyScape for exclusive flight deals</h2>
        </motion.div>
        ...
        >
          <p className="text-sm text-gray-600">
            ...
            <Link to="/login" className="font-medium text-emerald-600 hover:text-emerald-500 underline decoration-emerald-300 underline-offset-2 transition-colors">
              Sign in
            </Link>
          </p>
        </motion.div>
