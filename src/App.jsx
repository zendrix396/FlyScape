...
// Wrapper component that can access the theme context
function AppContent() {
  ...
  return (
    <>
      <div className={`min-h-screen flex flex-col ${isDark ? 'bg-gray-900' : 'bg-white'} transition-colors duration-300`}>
        <Routes>
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-6">
                  <div className="text-center md:text-left max-w-xs">
                    <div className="flex items-center justify-center md:justify-start gap-2 mb-2">
                      <div className={`h-8 w-8 rounded-full ${isDark ? 'bg-gray-700' : 'bg-white'} flex items-center justify-center`}>
                      ...
                      <h3 className={`text-lg font-bold ${isDark ? 'text-emerald-400' : 'text-emerald-600'}`}>FlyScape</h3>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-x-8 gap-y-2 text-center md:text-left">
                    <a href="/" className={`text-sm ${isDark ? 'text-gray-300 hover:text-white' : 'text-emerald-700 hover:text-emerald-600'}`}>Home</a>
                    <a href="/flights" className={`text-sm ${isDark ? 'text-gray-300 hover:text-white' : 'text-emerald-700 hover:text-emerald-600'}`}>Flights</a>
                    <a href="/bookings" className={`text-sm ${isDark ? 'text-gray-300 hover:text-white' : 'text-emerald-700 hover:text-emerald-600'}`}>My Bookings</a>
                    <a href="/profile" className={`text-sm ${isDark ? 'text-gray-300 hover:text-white' : 'text-emerald-700 hover:text-emerald-600'}`}>My Account</a>
                  </div>
                  ...
                  <div className="text-center md:text-right">
                    ...
                    <div className="flex space-x-4 mt-2 justify-center md:justify-end">
                      <a href="#" className={`text-xs ${isDark ? 'text-gray-400 hover:text-white' : 'text-emerald-700 hover:text-emerald-600'}`}>Privacy</a>
                      <a href="#" className={`text-xs ${isDark ? 'text-gray-400 hover:text-white' : 'text-emerald-700 hover:text-emerald-600'}`}>Terms</a>
                      <a href="#" className={`text-xs ${isDark ? 'text-gray-400 hover:text-white' : 'text-emerald-700 hover:text-emerald-600'}`}>Support</a>
                    </div>
                  </div>
                </div>
              </div>
